...
// MARK: - 自定义组件
extension HCAccountLoginable where Self: RegisteredViewController {
...
//    }
    ...
    func initLoginBtnView(onNext: @escaping (_ event: AccountLoginEvent) -> Void) -> (UIView, UIButton) {
        ...
        let loginBtn = UIButton().then {
            ...
            $0.setBackgroundImage(UIImage.init(color: kThemeTomatoColor, size: CGSize(width: 1, height: 1)), for: .normal)
